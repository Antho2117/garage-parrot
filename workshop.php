...
require_once __DIR__."/lib/validateFormWorkshop.php";

$booking = validateFormWorkshop($pdo);
...
<aside>
    ...
    <a href="tel:+01234567890" class="link-opacity-50-hover">
...
<!-- Form -->
<main class="my-md-5">
    <form method="post" action="<?= $booking ?>" class="container-fluid col-md-6 col-lg-5 col-xl-4"><div class="my-3">
