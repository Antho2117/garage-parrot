        ...
        <div class="dropdown-menu col-12 bg-secondary">
            <div class="container-fluid d-flex flex-column align-items-center">
                ...
                <?php foreach ($cars as $car): ?>
                    <button type="button" class="btn btn-warning col-9 m-2 p-1">
                    ...
                    <form method="post" class=" col-9 d-flex flex-column" enctype="multipart/form-data">
                        ...
                        <button
                                type="submit"
                                class="btn btn-info text-white my-2"
                        >Envoyer
                        </button>
                    </form>
                <?php endforeach; ?>
    ...
    <div class="dropdown d-flex justify-content-center">
        ...
        <div class="dropdown-menu col-12 bg-secondary">
            <div class="d-flex flex-column align-items-center">
                ...
                <?php foreach ($cars as $car): ?>
                    <a type="button" href="<?= ROOT ?>/employee/deleteCar/<?= $car->id_car ?>" class="btn btn-danger col-5 m-2" onclick="deleteCar()">
                        <?= ucfirst($car->car_brand). " " . $car->car_year ." : ".$car->car_price."€"; ?>
                    </a>
                <?php endforeach; ?>
            </div>
